...
// components
import { getIcon, sizeIconGrid } from '../../../components/Common';
...
export default function GroupMenu() {
      ...
      <Scrollbar>
        {accessRights?.support_detail ? (
          <Tooltip title="Detail">
            <IconButton
              ...
              size="small"
            >
              {getIcon(iconDetail, sizeIconGrid)}
            </IconButton>
          </Tooltip>
        ) : (
          ''
        ...
        <Tooltip title="Menu Access">
          <IconButton
            ...
            size="small"
          >
            {getIcon(iconChecklistAll, sizeIconGrid)}
          </IconButton>
        </Tooltip>
        ...
        {accessRights?.support_delete ? (
          <Tooltip title="Delete">
            <IconButton
              ...
              size="small"
            >
              {getIcon(iconDelete, sizeIconGrid)}
            </IconButton>
          </Tooltip>
        ) : (
          ''
  ...
  const head = [
    ...
    {
      field: 'group_menu_desc',
      headerName: 'Group Menu Description',
      disableColumnMenu: true,
      type: 'string',
      width: 200,
      renderCell: RenderExpandCell
  ...
  return (
    <>
      ...
      >
        ...
        <MenuItem component={RouterLink} to={`menu_access/${shortCrypt('encrypt', params.value)}`}>
          <Icon icon={iconChecklistAll} style={{ ...ICON }} />
          Menu Access
        </MenuItem>
        {accessRights?.support_edit ? (
