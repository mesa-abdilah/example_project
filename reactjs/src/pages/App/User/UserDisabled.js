...
import { tokenEmpty, getCurrentUser, isBooleantoString } from '../../../utils/orms_commonly_script';
import {
  textCancle,
  textSave,
...
export default function UserActivation() {
    ...
    Service.getDataUser(id)
      .then((response) => {
        if (response.status === 200) {
          setuserId(response.data[0].pk_user_id);
  ...
  return (
    <Page title="ORMs User Activation">
      <Container>
