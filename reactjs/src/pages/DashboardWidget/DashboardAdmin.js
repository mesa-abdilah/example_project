...
// import YearlyOrder from './YearlyOrder';

// ----------------------------------------------------------------------

DashboardAdmin.propTypes = { orderList: PropTypes.array, summary: PropTypes.array };

export default function DashboardAdmin({ orderList, summary }) {
  return (
