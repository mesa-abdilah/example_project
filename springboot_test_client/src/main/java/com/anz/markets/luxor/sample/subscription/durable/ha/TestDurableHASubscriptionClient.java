package com.anz.markets.luxor.sample.subscription.durable.ha;
...
@ImportResource("classpath:subscription/durable/ha/ha-durable-subs-client-context-embedded.xml")
public class TestDurableHASubscriptionClient {

    private static final Logger logger = LogManager.getLogger(TestDurableHASubscriptionClient.class);
    public static final String CONTEXT_FILE_LOCATION = "classpath:subscription/durable/ha/ha-durable-subs-client-context-embedded.xml";
    public static final String CONFIG_FILE_LOCATION = "classpath:subscription/durable/ha/ha-durable-subs-client-config.properties";
    ...
    public static void testClient(String bootType) throws Exception {
        ...
        switch (bootType){
            case "SPRING-XML":
                ...
                break;
            case "SPRING-BOOT":
                luxorClient = clientApplicationManager.buildLuxorClientWithSpringBoot(TestDurableHASubscriptionClient.class);
                break;
            default:
